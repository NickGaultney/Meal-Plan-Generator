...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference("Component.count") do
      post components_url, params: { component: { ingredients_id: @component.ingredients_id, quantity: @component.quantity, recipe_id: @component.recipe_id, unit: @component.unit } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { ingredients_id: @component.ingredients_id, quantity: @component.quantity, recipe_id: @component.recipe_id, unit: @component.unit } }
